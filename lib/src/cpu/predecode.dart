...
class Rv64Predecoder {
  ...
  static void _decodeCompressedQ0(
    ...
    switch (funct3) {
      ...
      case 3:
        final imm = _field(insn, 10, 3, 5) | _field(insn, 5, 6, 7);
        return _store(
          page,
          slot,
          PredecodeOp.ld,
    ...
    switch (funct3) {
      case 0:
        ...
        final imm = _signExtend(
          _field(insn, 12, 5, 5) | _field(insn, 2, 0, 4),
          6,
        );
        return _store(
          page,
      ...
      case 3:
        ...
        if (rd == 0) return _nop(page, slot, 2);
        final imm = _signExtend(
          _field(insn, 12, 17, 17) | _field(insn, 2, 12, 16),
          18,
        );
      ...
      case 5:
        return _store(page, slot, PredecodeOp.j, 2, imm: _jImm(insn));
      case 6:
        final rs1Prime = ((insn >> 7) & 7) | 8;
        return _store(
          page,
  ...
  static void _decodeCompressedArith(DecodedPage page, int slot, int insn) {
    ...
    switch (subFunct) {
      case 0:
      case 1:
        final imm = _field(insn, 12, 5, 5) | _field(insn, 2, 0, 4);
        return _store(
          page,
          slot,
  ...
  static void _decodeCompressedQ2(
    ...
    switch (funct3) {
      case 0:
        if (rd == 0) return _nop(page, slot, 2);
        final imm = _field(insn, 12, 5, 5) | rs2;
        return _store(
          page,
          slot,
          PredecodeOp.slli,
      ...
      case 2:
        ...
        final imm =
            _field(insn, 12, 5, 5) | (rs2 & (7 << 2)) | _field(insn, 2, 6, 7);
        return _store(page, slot, PredecodeOp.lw, 2, rd: rd, rs1: 2, imm: imm);
      case 3:
        if (rd == 0) return _fallback(page, slot, 2);
        final imm =
            _field(insn, 12, 5, 5) | (rs2 & (3 << 3)) | _field(insn, 2, 6, 8);
      ...
      case 6:
        final imm = _field(insn, 9, 2, 5) | _field(insn, 7, 6, 7);
        return _store(
          page,
          slot,
          PredecodeOp.sw,
      ...
      case 7:
        final imm = _field(insn, 10, 3, 5) | _field(insn, 7, 6, 8);
        return _store(
          page,
          slot,
          PredecodeOp.sd,
  ...
  static int _field(int insn, int srcPos, int dstPos, int dstPosMax) {
  ...
  static int _jImm(int insn) => _signExtend(
    _field(insn, 12, 11, 11) |
        _field(insn, 11, 4, 4) |
        _field(insn, 9, 8, 9) |
        _field(insn, 8, 10, 10) |
        _field(insn, 7, 6, 6) |
  ...
  static int _branchImm(int insn) => _signExtend(
    _field(insn, 12, 8, 8) |
        _field(insn, 10, 3, 4) |
        _field(insn, 5, 6, 7) |
        _field(insn, 3, 1, 2) |
