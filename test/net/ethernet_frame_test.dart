...
void main() {
  group('EthernetFrame', () {
    final dstMac = Uint8List.fromList([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]);
    final srcMac = Uint8List.fromList([0x02, 0x00, 0x00, 0x00, 0x00, 0x01]);
    ...
    test('encode produces correct header size', () {
      ...
      expect(encoded.length, EthernetFrame.headerSize + payload.length);
    });
